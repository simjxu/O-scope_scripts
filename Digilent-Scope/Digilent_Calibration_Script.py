...
if dev0.value == hdwfNone.value:
    ...
    quit()
# Device 1: outputting signal from Device
...
# hzAcq = c_double(6664)
# nSamples = 16384
# print("Generating custom waveform...")  # SET CREATE OUTPUT OUT OF CHANNEL
# shiftarr1500 = [2.8300, 3.0000, 0.6700, -0.0410, 2.9730, 4.1420, -0.0480, -0.2870, 2.9900, 0.1500,
#                 2.7410, 1.8300, 1.3550, 0.9900, 1.4100]
# shiftarr3000 = [3.0600, 3.5100, 1.0250, -0.1510, 2.6330, 4.0420, 0.0820, -0.2070, 2.9800, 0.2200,
#                 2.7100, 2.1300, 1.6100, 1.7300, 1.6600]
# shiftarr4000 = [2.7500, 2.1000, 1.0800, 1.0900, 1.7600, 3.6200, -1.7500, 0.6400, 4.0300, 0.9200]
# shiftarr5000 = [3.5100, 1.5700, 1.3400, 1.8600, 1.1600, 3.4800, -0.7700, 1.2600, 3.5800, 0.2100]
# shiftarr6000 = [3.5500, 1.6200, 1.3700, 1.4700, 0.9100, 3.3600, -1.1100, 0.7800, 3.5700, 1.1500]
# freqarr = [100 * (i + 1) for i in range(len(shiftarr1500))]
# rgdSamples = custom_waveform(freqarr, shiftarr1500, amplitude=0.2, simulated_sampling_rate=100000, time_length=0.01)
# generate_samples(dev0, c_int(0), rgdSamples, time_length=0.01)
# # BEGIN ACQUISITION ----------------------------------------------
...
# dwf.FDwfAnalogInConfigure(dev1, c_bool(True), c_bool(True))
# # Acquire samples, Device 0 Channel 0
# dev0chan0_values = acquire_samples(dev0, c_int(0), hzAcq, nSamples)
# # Acquire samples, Device 0 Channel 1
# dev0chan1_values = acquire_samples(dev0, c_int(1), hzAcq, nSamples)
# # Acquire samples, Device 1 Channel 0
# dev1chan0_values = acquire_samples(dev1, c_int(0), hzAcq, nSamples)
# # END ACQUISITION ------------------------------------------------
# t = [i/hzAcq.value for i in range(nSamples)]
# plt.plot(t, dev0chan0_values)
# plt.title("Device 0 Channel 0")
# plt.show()
# plt.plot(t, dev0chan1_values)
# plt.title("Device 0 Channel 1")
# plt.show()
# plt.plot(t, dev1chan0_values)
# plt.title("Device 1 Channel 0")
# plt.show()
# dwf.FDwfDeviceCloseAll()
# print(dev0chan0_values)
# print("Channel 1 -------------------")
# reference_values1 = get_reference_values(dev0chan0_values, freqarr, sampling_rate=hzAcq.value, num_samples=8192, axis=1)
# print("Channel 2 -------------------")
# reference_values2 = get_reference_values(dev0chan1_values, freqarr, sampling_rate=hzAcq.value, num_samples=8192, axis=2)
# print("Channel 3 -------------------")
# reference_values3 = get_reference_values(dev1chan0_values, freqarr, sampling_rate=hzAcq.value, num_samples=8192, axis=3)
#
# print(reference_values1)